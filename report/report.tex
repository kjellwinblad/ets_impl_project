...
The ETS tables are used as a way to efficiently share memory between processes. 
...
\begin{itemize}
 \item If the table type shall be \verb|set|, \verb|bag |or \verb|duplicate_bag| (See section~\ref{sec:different_table_types}).
 \item The access level which can be \verb|private|, \verb|protected| and \verb|public|.
\end{itemize}
...
\section{Different Table Types} \label{sec:different_table_types}
