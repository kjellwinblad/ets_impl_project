...
This feature is included for the following main reasons:
\begin{enumerate}
\item 
...
Since ETS is mostly implemented in the lower level programming language C, it is probably faster than what could be accomplished with a pure Erlang implementation.
